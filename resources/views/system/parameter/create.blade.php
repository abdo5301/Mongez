                ...
                {!! Form::open(['route' => isset($result) ? ['system.parameter.update',$result->id]:'system.parameter.store','files'=>true, 'method' => isset($result) ?  'PATCH' : 'POST','class'=> 'k-form','id'=> 'main-form','onsubmit'=> 'submitMainForm();return false;']) !!}
                    <div class="k-portlet__body">
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                <label>{{__('Type')}}*</label>
                                {!! Form::select('type',['text'=> __('Text'),'textarea'=> __('Textarea'),'number'=> __('Number'),'select'=> __('Select'),'multi_select'=> __('Multi Select'),'radio'=> __('Radio Buttons')],isset($result) ? $result->type : null,['class'=>'form-control','id'=>'type-form-input','onchange'=>'changeType($(this).val())']) !!}
                            ...
                            <div class="col-md-4">
                                <label>{{__('Display on request')}}*</label>
                        ...
                        <div class="form-group row number-div" style="display:none;">
                            ...
                            <div class="col-md-12">
                                <label>{{__('Between request')}}*</label>
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        function changeType($value){
            ...
            if($value == 'number'){
                $('.number-div').show();
            }else if($value == 'select' || $value == 'multi_select' || $value == 'radio'){
                $('.multi-div').show();
            }
        }
