    ...
    <div class="k-content__head	k-grid__item">
        ...
        <div class="k-content__head-toolbar">
            <div class="k-content__head-wrapper">
                <a href="#" data-toggle="modal" data-target="#create-call-modal" class="btn btn-sm btn-elevate btn-brand" data-toggle="k-tooltip" title="{{__('Search on below data')}}" data-placement="left">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @else
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            {!! Form::text('client_id_hidden',$client_info->name,['class'=>'form-control','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                ...
                <div class="form-group row" id="remind_me_on_div" style="display: none;">
                    <div class="col-md-12">
                        <label>{{__('On')}}*</label>
                        {!! Form::text('remind_me_on',null,['class'=>'form-control k_datetimepicker_2','id'=>'remind_me_on-form-input','autocomplete'=>'off']) !!}
