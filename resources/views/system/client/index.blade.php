            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row mb1">
                        ...
                        <div class="col-md-6">
                            <label>{{__('Type')}}</label>
                            {!! Form::select('type',[''=>__('All'),'client'=>__('Client'),'investor'=>__('Investor')],null,['class'=>'form-control']) !!}
                        </div>


                        <div class="col-md-6">
                            <label>{{__('Investor Type')}}</label>
                            {!! Form::select('investor_type',[''=>__('All'),'individual'=>__('Individual'),'company'=>__('Company'),'broker'=>__('Broker')],null,['class'=>'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb1">
                        <div class="col-md-12">
                            ...
                            {!! Form::number('created_by_staff_id',null,['class'=>'form-control']) !!}
                        </div>
                    </div>
                ...
                <table style="text-align: center;" class="table table-striped- table-bordered table-hover table-checkable" id="datatable-main">
                    ...
                    <tr>
                        ...
                        <th>
                            ...
                            <div class="dropdown">
                                <a id="th_type_a" href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="false">
                                    {{__('Type')}}  <b class="caret"></b>
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a onclick="$('#th_type').val('').change();" href="javascript:void(0);">{{__('Select')}}</a></li>
                                    <li><a onclick="$('#th_type').val('client').change();" href="javascript:void(0);">{{__('Client')}}</a></li>
                                    <li><a onclick="$('#th_type').val('investor').change();" href="javascript:void(0);">{{__('Investor')}}</a></li>
                                </ul>
                            </div>
                            <input id="th_type" type="hidden" />
                        ...
                        <th>
                            <div class="dropdown">
                                <a id="th_status_a" href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="false">
                                    {{__('Status')}}  <b class="caret"></b>
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a onclick="$('#th_status').val('').change();" href="javascript:void(0);">{{__('Select')}}</a></li>
                                    <li><a onclick="$('#th_status').val('active').change();" href="javascript:void(0);">{{__('Active')}}</a></li>
                                    <li><a onclick="$('#th_status').val('in-active').change();" href="javascript:void(0);">{{__('In-Active')}}</a></li>
                                </ul>
                            </div>
                            <input id="th_status" type="hidden" />
                        </th>
                        <th>{{__('Created At')}}</th>
                        <th>{{__('Created By')}}</th>
                        <th>{{__('Action')}}</th>
