...
class Staff extends Authenticatable
{
    ...
    public function property(){
        return $this->hasMany('App\Models\Property','created_by_staff_id')
            ->orWhere('properties.sales_id',$this->id);
    }

    public function requests(){
        return $this->hasMany('App\Models\Request','created_by_staff_id')
            ->orWhere('requests.sales_id',$this->id);
    }
